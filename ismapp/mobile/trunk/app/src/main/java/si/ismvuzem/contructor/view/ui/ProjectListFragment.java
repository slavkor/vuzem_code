package si.ismvuzem.contructor.view.ui;
...
import si.ismvuzem.contructor.viewmodel.ProjectListViewModel;
...
*/
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        final ProjectListViewModel viewModel = ViewModelProvider.AndroidViewModelFactory.getInstance(getActivity().getApplication()).create(ProjectListViewModel.class);
