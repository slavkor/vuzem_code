    ...
    class ReportsContextViewModel : ViewModelBase
    {
        ...
        private void RefreshReportsForContext()
        {
            try
            {
                ...
                {
                    repository.GetRequestAsync(new Uri(_settingsService.GetApiServer(false), $"reports/list/context/{Context}/{_securityService.GetCurrentToken().GetClaim("sub")}").ToString(),
