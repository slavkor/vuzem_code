...
namespace Ism.Security.Services
{
    public class SecurityService : ISecurityService
    {
        ...
        public void SetCurrentToken(Token token, Company company)
        {
            try
            {
                _currentToken = token;
        ...
        public bool HasPermission(string key)
        {
            ...
            var scopes = _currentToken.Scopes;
            return scopes.Any(scope => scope.Identifier == "admin") || scopes.Any(scope => scope.Identifier == key);
        }
        ...
        {
            if (_currentToken == null) return false;
            return _currentToken.Scopes.Any(scope => scope.Identifier == key);
