...
namespace Ism.Construction.ViewModels
{
    public class NavConstructionViewModel : ViewModelBase
    {
        ...
        public NavConstructionViewModel(ISecurityService securityService, IExceptionService exceptionService)
        {
            ...
            NavigateConstrucitonSiteEmployeesCommand = new DelegateCommand(OnNavigateConstrucitonSiteEmployeesCommand, () => _securityService.HasPermission("csite"));
        ...
        public DelegateCommand NavigateConstrucitonSiteEmployeesCommand { get; }
        ...
        private void OnNavigateConstrucitonSiteEmployeesCommand()
        {
            try
            {
                ...
                {
                    Header = "Pregled gradbišč"
                });
                _regionManager.RequestNavigate(Ism.Infrastructure.RegionNames.MainContentRegion, "ConstructionSiteEmployeesView", par);
            }
            catch (Exception exception)
            {
                _exceptionService.RaiseException(exception);
