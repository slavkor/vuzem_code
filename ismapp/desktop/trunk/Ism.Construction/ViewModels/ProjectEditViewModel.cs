    ...
    public class ProjectEditViewModel : ViewModelBase
    {
        ...
        private void DownloadProjectImage(Project obj)
        {
            try
            {
                ...
                {
                    rep.GetRequestAsync(new Uri(_settings.GetApiServer(), $"projects/{obj.UuId}/document/{commons.GetDocumentTypes().FirstOrDefault(t => t.Name == "SLIKA")?.Name}").ToString(), _securityService.GetCurrentToken(), Project =>
                        {
