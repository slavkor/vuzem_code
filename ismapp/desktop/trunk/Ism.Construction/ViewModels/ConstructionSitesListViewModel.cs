...
namespace Ism.Construction.ViewModels
{
    public class ConstructionSitesListViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<ConstructionSiteOverview> _sites;

        public ObservableCollection<ConstructionSiteOverview> Sites
        {
            get { return _sites; }
                ...
                switch (_tabindex)
                {
                    ...
                    case 2:
                        using (var repository = _serviceLocator.GetInstance<IRestRepository<List<ConstructionSiteList>, Range>>())
                        {
                            ...
                            repository.PostRequestAsync(new Uri(_settingsService.GetApiServer(), "csite/list").ToString(), range, _securityService.GetCurrentToken(),
                                (e) =>
                                {
                    ...
                    case 3:
                        using (var repository = _serviceLocator.GetInstance<IRestRepository<List<ConstructionSiteOverview>, object>>())
                        {
                            ...
                            repository.GetRequestAsync(new Uri(_settingsService.GetApiServer(true), "csite/listoverview").ToString(), _securityService.GetCurrentToken(),
                                (e) =>
                                {
                                    Sites = new ObservableCollection<ConstructionSiteOverview>(e);
                                });
                        }
