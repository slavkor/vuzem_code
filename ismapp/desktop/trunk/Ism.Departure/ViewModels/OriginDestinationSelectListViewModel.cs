        ...
        private void RefreshList()
        {
            try
            {
                ...
                using (var rep = _serviceLocator.GetInstance<IRestRepository<List<Project>, string>>())
                {
                    ...
                    {
                        rep.GetRequestAsync(new Uri(_settingsService.GetApiServer(), $"csite/{_securityService.GetCurrentSite().UuId}/project/list").ToString(), _securityService.GetCurrentToken(),
                        list =>
                        {
                    ...
                    rep.GetRequestAsync(new Uri(_settingsService.GetApiServer(), $"project/list/{(int)ProjectState.InProgress}").ToString(), _securityService.GetCurrentToken(),
                        list =>
                        {
                            List = new ObservableCollection<IDepartureArrival>();
                            List.Add(_securityService.GetCurrentCompany());
