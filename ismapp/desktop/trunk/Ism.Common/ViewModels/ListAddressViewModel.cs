...
{
    public class ListAddressViewModel: ViewModelBase, IInteractionRequestAware
    {
        ...
        public ListAddressViewModel(ISecurityService securityService, ISettingsService settingsService, IExceptionService exceptionService)
        {
        ...
        private void RefreshAddresses()
        {
            try
            {
                ...
                //Addresses = _notification.DataProvider?.Invoke();
            }
            catch (Exception e)
            {
                _exceptionService.RaiseException(e);
