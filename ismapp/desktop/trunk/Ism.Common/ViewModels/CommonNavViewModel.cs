...
namespace Ism.Common.ViewModels
{
    public class CommonNavViewModel : ViewModelBase
    {
        ...
        public CommonNavViewModel(ISecurityService securityService, IExceptionService exceptionService)
        {
            ...
            PrintPdfInteractionRequest = new InteractionRequest<ListInteraction<PrintEventAgrs>>();
            _eventAggregator.GetEvent<PrintPdfEvent>().Subscribe(OnPrintPdfEvent);
        ...
        public InteractionRequest<ListInteraction<PrintEventAgrs>> PrintPdfInteractionRequest { get; }
        ...
        private void OnPrintPdfEvent(PrintEventAgrs obj)
        {
            try
            {
                PrintPdfInteractionRequest.Raise(new EditInteraction<PrintEventAgrs>() { Title = "Tiskanje", InteractionObject = obj, SaveAction = null, EditMode = EditMode.Undefined});
