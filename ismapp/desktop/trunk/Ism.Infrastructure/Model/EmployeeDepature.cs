...
namespace Ism.Infrastructure.Model
{
    public class EmployeeDepature : Employee
    {
        ...
        //private IList<EmployeeDepatureEx> planeddepartures;
        ...
        //[JsonProperty(PropertyName = "planeddepartures", NullValueHandling = NullValueHandling.Ignore)]
        //public IList<EmployeeDepatureEx> PlanedDepartures
        //{
        //    get
        //    {
        //        return planeddepartures;
        //    }
        //    set
        //    {
        //        SetProperty(ref planeddepartures, value);
        //        PropertyDeletegate?.Invoke(this);
        //    }
        //}
    ...
    //public class EmployeeDepatureEx :BaseModel
    //{
    //    private DepartureEx departure;
    //    [JsonProperty(PropertyName = "departure", NullValueHandling = NullValueHandling.Ignore)]
    //    public DepartureEx Departure
    //    {
    //        get
    //        {
    //            return departure;
    ...
    //        set
    //        {
    //            SetProperty(ref departure, value);
    //            PropertyDeletegate?.Invoke(this);
    //        }
    //    }
    //}
