    ...
    class LanguagesViewModel : ViewModelBase
    {
        ...
        private void OnLanguageInteractionRequestCallback(EditInteraction<Language> obj)
        {
            try
            {
                ...
                {
                    rep.PostRequestAsync(new Uri(_baseUri, "shrd/lang/add").ToString(), obj.InteractionObject, _securityService.GetCurrentUser().AccessToken,
                        list =>
                        {
                            RefreshLanguages();
                        });
        ...
        private void RefreshLanguages()
        {
            try
            {
                ...
                {
                    rep.GetRequestAsync(new Uri(_baseUri, "shrd/lang/list").ToString(), _securityService.GetCurrentUser().AccessToken,
                        list =>
                        {
                            Languages = list;
                        });
