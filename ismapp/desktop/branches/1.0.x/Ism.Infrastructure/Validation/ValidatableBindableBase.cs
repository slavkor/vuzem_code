...
namespace Ism.Infrastructure.Validation
{
    ...
    public class ValidatableBindableBase : BindableBase, IValidatableBindableBase
    {
        ...
        [JsonIgnore]
        public bool HasErrors => Errors?.Errors?.Count > 0;
        ...
        public string this[string columnName]
        {
            get
            {
                ReadOnlyCollection<string> ers;
                _bindableValidator.Errors.TryGetValue(columnName, out ers);
                return ers?.FirstOrDefault();
            }
        }
