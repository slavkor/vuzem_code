        ...
        public override void OnNavigatedTo(NavigationContext navigationContext)
        {
            try
            {
                ...
                if(null == sitedata)
                {
                    ...
                    {
                        rep.GetRequestAsync(new Uri(_settingsService.GetApiServer(), $"csite/byemployee/{_securityService.GetCurrentEmployee().UuId}").ToString(), _securityService.GetCurrentUser().AccessToken, (site) =>
                        {
                            try
                            {
                                if (site == null) return;
