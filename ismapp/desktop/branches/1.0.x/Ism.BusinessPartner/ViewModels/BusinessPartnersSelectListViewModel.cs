...
{
    public class BusinessPartnersSelectListViewModel : ViewModelBase, IInteractionRequestAware
    {
        ...
        public BusinessPartnersSelectListViewModel(ISettingsService settingsService, ISecurityService securityService, IExceptionService exceptionService)
        {
        ...
        private void RefreshPartners()
        {
            try
            {
                ...
                {
                    rep.GetRequestAsync(new Uri(_settingsService.GetApiServer(), "partners/list").ToString(), _securityService.GetCurrentUser().AccessToken,
                        list =>
                        {
                            Partners = list;
